...
class RandomCrop_spa(object):
    def __init__(self, size, spatial_matrix):
        self.size = size
    ...
    def __call__(self, image, target):
        ...
        spatial_matrix = F.crop(self.spatial_matrix, i, j, h, w)

        return image, target, spatial_matrix
